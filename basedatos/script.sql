...
CREATE VIEW vista1 (NOMBRE_USUARIO, TELEFONO, ID_ALOJAMIENTO, NOMBRE, FECHA_ENTRADA, FECHA_SALIDA) AS SELECT NOMBRE_COMPLETO, Telefono, Id_Alojamiento, Nombre, Fecha_Entrada, Fecha_Salida
